...
function showSuccessMessage(message, target) {
    ...
    var elem = $(target + " #alertMessage span");
    if (elem.length === 0) {
        $(target + " #alertMessage").remove();
    }

    $(target).prepend('<div class="alert alert-success fade in" id="alertMessage"><a href="#" class="close" data-dismiss="alert">&times;</a><span>' + message + '</span></div>');

    $(target + " #alertMessage").fadeTo(2000, 500).slideUp(500, function () {
        $(target + " #alertMessage").remove();
    });
}
...
function showErrorMessage(message, target) {
    ...
    var elem = $("#alertMessage span");
    if (elem.length === 0) {
        $("#alertMessage").remove();
    }

    $(target).prepend('<div class="alert alert-danger fade in" id="alertMessage"><a href="#" class="close" data-dismiss="alert">&times;</a><span>' + message + '</span></div>');
...
function showInfoMessage(message, target) {
    ...
    $(target).prepend('<div class="alert alert-info fade in" id="alertMessage"><a href="#" class="close" data-dismiss="alert">&times;</a><span>' + message + '</span></div>');

    $(target + " #alertMessage").fadeTo(2000, 500);
}
